...
// Constant-time bcrypt: used to equalise login response time when the user
// does not exist. Prevents user enumeration via timing analysis.
...
export class AuthService {
  ...
  private async verifyCredentials(emailInput: string, password: string) {
  ...
  async login(emailInput: string, password: string) {
    const user = await this.verifyCredentials(emailInput, password);
